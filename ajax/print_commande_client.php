<!DOCTYE html>
	...
	<div class="panier">
			...
			<?php 
				...
				$seldetails = $bdd -> prepare ("SELECT * FROM detailscommande, articles , commande, client WHERE articles.ID_articles= detailscommande.articles AND detailscommande.commande = commande.ID_commande AND commande.ID_commande=detailscommande.commande AND commande.client=? AND commande.client=client.ID_client ");
			 	$seldetails -> execute (array($_GET['leclient'])); 
					...
					<div class="imprimer">
						<table> 
							<tr>
								...
								<td><a href="../ajax/print_commande_client.php?leclient='.$_GET['leclient'].'">Imprimer</a></td>
							</tr>
						</table>
					</div>
						';
